 ...
 * --------------------------------------------------------------------------
 *
 * Full Path: C:\Projects\Phoenix\Engines\Verification\DTO\VerificationResult.php
 *
 * Artifact ID: DTO-000002
 * File ID: FILE-000014
 *
 * Title:
 * Verification Result
...
namespace Phoenix\Engines\Verification\DTO;
...
final readonly class VerificationResult implements JsonSerializable
{
    ...
    /**
     * Indicates whether the verification failed.
     */
